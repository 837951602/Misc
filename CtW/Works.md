...
<tr><td>obtain info from outside of game without console</td><td>Mf V(1.9-)</td><td>Corner structure block reloads the structure when powered<br>Alternatively, you can "reload" with `datapack enable/disable %any%`</td><td>chyx, Marcono1234, ?</td></tr>
