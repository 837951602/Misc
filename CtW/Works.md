...
<tr><td>g.general item duplicate; mob GUI save preventer</td><td>MP V(1.14-) Pc</td><td>When a player and a mob riding directly/player riding on the mob, the player exiting despawns the mob till his next entering, but GUI if opened by someone else can still be altered and not saved. <br>Founded and submitted by 延皓和赤柴凯撒 showing it applies to villagers, and CtW and chyx showed it also applies to donkeys.</td><td>延皓和赤柴凯撒, Bad_Apples</td></tr>
...
<table>
  <tr><th>Author</th><th>Licence</th><th>Note</th></tr>
  <tr><td>CtW</td><td>https://github.com/837951602/Misc/blob/master/CtW/CtwLicense.md</td><td></td></tr>
</table>
